...
/**
 * @dev ERC223 token - https://github.com/ethereum/EIPs/issues/223
 */
contract ERC223 is IERC223, Ownable
{
    ...
    /**
    * @dev Sends tokens to the supplied recepient address,
    * possible to provide additional transaction data.
    *
    * @param value Number of transferred tokens.
    ...
    */
    ...
    /**
    * @dev Sends tokens to the supplied recepient address,
    * fails if doesn't have enough token allowance for the transaction,
    * possible to provide additional transaction data.
    *
    * @param value Number of transferred tokens.
    * @param to Recepient address.
    ...
    */
    ...
    /**
    * @dev Sends tokens for each address in the supplied array,
    * possible to provide additional transaction data.
    *
    * @param value Number of transferred tokens.
    * @param to Recepients' addresses array.
    * @param data Optional transaction data.
    */
    ...
    /**
    * @dev Checks if the supplied address is a smart contract.
    *
    ...
    */
    ...
    /**
    * @dev Burns tokens from the own balance.
    *
    * @param amountToBurn Number of burned tokens.
    */
    ...
    /**
    * @dev Contract's owner is able to move the accidentally sent 
    * ERC20 tokens out from this contract.
    */
    ...
    function checkAddressValidity(address _address) internal view
    {
        ...
        require(_address != address(this), "The address can't point to smart contract.");
    }
